...
export class Backend implements backendInterface {
    ...
    async listFocusSessions(): Promise<Array<FocusSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.listFocusSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordFocusSession(arg0: bigint): Promise<FocusSession> {
        if (this.processError) {
            try {
                const result = await this.actor.recordFocusSession(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStreak(arg0: bigint, arg1: bigint, arg2: string): Promise<StreakData> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStreak(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
